...
def main():
    ...
    scores = model_selection.cross_val_score(modelSGDC, X, Y, scoring="neg_mean_squared_error", cv=10)
    ...
    joblib.dump(modelSGDC, './models/sgradientd_classifier.joblib') 
    ...
    print("- joined:\n", joined.head())
    print("# Writing predictions to bernie_submissions_sgdc.csv...")
    # Save the predictions out to a CSV file.
    joined.to_csv("./results/bernie_submission_sgdc.csv", index=False)
